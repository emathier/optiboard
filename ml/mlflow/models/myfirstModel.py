...
sql_query = """
SELECT cloud_cover, apparent_temperature, wind_speed_10m, precipitation, CAST(hallenbad_city AS DOUBLE) AS hallenbad_city
...
with mlflow.start_run():
    mlflow.log_input(mlflow.data.from_pandas(train_df), context="train")
